...
//                 An intense 24-hour coding marathon where creative minds collaborated to build innovative tech solutions that could change the world
//               </p>
...
//                   Hack the Spring brought together passionate developers, designers, and innovators for an unforgettable 
//                      24-hour journey of creation, collaboration, and innovation. Teams worked around the clock to transform 
...
export default function Codethon() {
  ...
  const highlights = [
    ...
    { icon: Code, title: "Multiple Tracks", desc: "Web Dev, Mobile, AI/ML, IoT", color: "from-teal-400 to-blue-500" },
  ...
  const winners = [
    { 
      position: "1st Place", 
      team: "Ctrl C Ctrl V", 
      members: ["Smart Finance Tracker", "Full-stack web application"], 
      rank: 1,
      description: "Revolutionary personal finance management tool with AI-powered insights"
    },
    { 
      position: "2nd Place", 
      team: "Team Bit", 
      members: ["EcoRoute Navigator", "Mobile + Web Solution"], 
      rank: 2,
      description: "Sustainable transportation app optimizing routes for minimal carbon footprint"
    },
    { 
      position: "3rd Place", 
      team: "Penguins", 
      members: ["StudyBuddy AI", "Cross-platform application"], 
      rank: 3,
      description: "AI-powered collaborative learning platform for enhanced student engagement"
    }
  ];
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center mb-4">
                      ...
                      <div className="space-y-2 mb-4">
                        {winner.members.map((member, idx) => (
                          <p key={idx} className="text-blue-200/80 text-sm font-medium group-hover:text-blue-100/90 transition-colors">
                            {member}
                          </p>
                        ))}
                      </div>
                      <p className="text-blue-200/70 text-sm italic group-hover:text-blue-100/80 transition-colors leading-relaxed">
                        {winner.description}
                      </p>
                    </div>

                    <div className="border-t border-blue-400/20 pt-4 group-hover:border-cyan-400/30 transition-colors">
                      <div className="flex items-center justify-center gap-2 text-cyan-300 group-hover:text-cyan-200 transition-colors">
                        <Award size={16} />
                        <span className="text-sm font-medium">Outstanding Innovation</span>
                      </div>
                    </div>
                  </div>
                </div>
